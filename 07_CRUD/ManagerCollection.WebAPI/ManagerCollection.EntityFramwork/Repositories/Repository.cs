...
namespace GymManager.DataAccess.Repositories
{
    ...
    {
        private readonly ManagerCollectionContext _context;

        protected ManagerCollectionContext Context { get => _context; }

        public Repository(ManagerCollectionContext context)
        {
            _context = context;
        }
